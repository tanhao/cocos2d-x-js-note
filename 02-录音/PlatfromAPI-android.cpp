...
//const char kJavaAppActivityClass[] = "org/cocos2dx/javascript/AppActivity";
const char kJavaAudioRecorderClass[] = "org/cocos2dx/javascript/AudioRecorder";
...
{   
    ...
    //录音回调函数
	JNIEXPORT void JNICALL Java_org_cocos2dx_javascript_AudioRecorder_onAudioRecordEvent(
                                                                             JNIEnv*  env, 
                                                                             jclass thiz, 
                                                                             jstring path, 
                                                                             jdouble audioTime
